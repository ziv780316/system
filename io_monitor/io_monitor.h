...
#define IO_MONITOR_IPC_MONITOR_UNINIT 0x0
#define IO_MONITOR_IPC_MONITOR_OFF    0x1
#define IO_MONITOR_IPC_MONITOR_READ   0x2
#define IO_MONITOR_IPC_MONITOR_WRITE  0x4
#define IO_MONITOR_IPC_MONITOR_PSTREE 0x8
#define IO_MONITOR_IPC_MONITOR_ENV    0xf
#define IO_MONITOR_IPC_MONITOR_ALL (IO_MONITOR_IPC_MONITOR_READ|IO_MONITOR_IPC_MONITOR_WRITE|IO_MONITOR_IPC_MONITOR_PSTREE|IO_MONITOR_IPC_MONITOR_ENV)
